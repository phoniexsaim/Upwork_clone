      ...
      <div>
        ...
        <ul className="space-y-3">
          <li className="flex gap-2 items-start">
            ...
            <div>
              <strong className="text-[20px] font-[400]">No cost to join</strong>
          ...
          <li className="flex gap-2 items-start">
            ...
            <div>
              <strong className="text-[20px] font-[400]">Post a job and hire top talent</strong>
              <div className="text-[16px] font-[300]">
          ...
          <li className="flex gap-2 items-start">
            ...
            <div>
              <strong className="text-[20px] font-[400]">Work with the best—without breaking the bank</strong>
              <div className="text-[16px] font-[300]">
